    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                StringValue = (String) textValue.getText().toString();
                ...
                Snackbar.make(view, "Change Value " + originalValue + " to " + newValue + " !!! Shit you are sexy as fuck\n Yvonne is proud of you!!!", Snackbar.LENGTH_LONG)
